...
class Application (Frame):
    ...
    def create_widgets (self):
        """ Create widgets to get story and information to display story """
        ...
        # create variable for a single body part
        self.body_part = StringVar () # assign it to StringVar ()
        self.body_part.set (None) # set it to None

        # create body part radio buttons
        body_parts = ["bellybutton", "vagina", "knee", "butthole"]
        column = 1
    ...
    # create a class to use the values entered to create one long string
